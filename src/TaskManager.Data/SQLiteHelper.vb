...
Public Class SQLiteHelper
  ...
  Public Shared Sub SetupConnection()
    ...
    Using connection As New SQLiteConnection(DBPath)
      connection.Open()
      Dim createTableQuery As String = "CREATE TABLE Contact (Id INTEGER PRIMARY KEY, Name TEXT, Email TEXT, Phone INTEGER, Active INTEGER)"
  ...
  Shared Sub SeedData()
    ...
    contactRepo.InsertContact(New Core.Contact() With {.Name = "John Doe", .Email = "John@gmail.com", .Phone = 9999999999, .Active = 1})
    contactRepo.InsertContact(New Core.Contact() With {.Name = "Jane Smith", .Email = "Jane@gmail.com", .Phone = 9999999999, .Active = 1})
  End Sub
